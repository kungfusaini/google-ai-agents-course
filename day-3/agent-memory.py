...
## Telling the agent my fav color
await run_session(
    runner,
...
## MANUAL MEMORY FETCHING
# Search for color preferences
search_response = await memory_service.search_memory(
    app_name=APP_NAME, user_id=USER_ID, query="user birthday"
)
...
await run_session(
    auto_runner,
    "I gifted a new toy to my nephew on his 1st birthday! Is that ok?",
    "auto-save-test",
)
y
