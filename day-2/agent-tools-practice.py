...
image_agent = LlmAgent(
    ...
    name="image_agent",
    instruction="You MUST use the getTinyImage tool to generate images. Always call the tool first before describing anything.",
            ...
            if hasattr(part, "function_response") and part.function_response:
                ...
                for item in part.function_response.response.get("content", []):
                    ...
                    if item.get("type") == "image":
                        ...
                        with open("tiny_image.png", "wb") as f:
                            f.write(base64.b64decode(item["data"]))
                        print("Image saved to tiny_image.png")
